...
// Нигде нет описания, что делает твоя функция или процедура??
// код должен быть оформлен одинаково, правильные отступы, одинаковое оформление. Нет лишних пустых строк и пробелов.
...
Процедура ЗаполнитьПланировщикНаСервере()
	...
	// Добавляем проверку запроса, если ничего нет, то ничего и не делаем.
...
Функция НачалоРаботы(НомерСпискаДел)
	...
	// комментарии должны быть идентичны везде
	...
	//ИначеЕсли НомерСпискаДел = 4 Тогда // ЗАЧЕМ ДВА РАЗА 12 ЧАСОВ??? 
	//	Возврат 12 * 60 * 60 + 60 * 60; //12 00
